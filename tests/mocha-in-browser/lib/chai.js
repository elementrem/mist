...
var getOuterHTML = function(elemen) {
  if ('outerHTML' in elemen) return elemen.outerHTML;
  ...
  if (document.xmlVersion) {
    return xmlSerializer.serializeToString(elemen);
  } else {
    container.appendChild(elemen.cloneNode(false));
    html = container.innerHTML.replace('><', '>' + elemen.innerHTML + '<');
    container.innerHTML = '';
    return html;
  }
};

// Returns true if object is a DOM elemen.
