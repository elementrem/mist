...
(function () {
    ...
    ElementremProvider.prototype = Object.create(EventEmitter.prototype);
    ElementremProvider.prototype.constructor = ElementremProvider;
     ...
     */
    ElementremProvider.prototype._addResponseCallback = function(payload, callback) {
     ...
     */
    ElementremProvider.prototype._reconnectCheck = function() {
        var _this = this;
    ...
    /**
     ...
     @method connect
     */
    ElementremProvider.prototype._connect = function(payload, callback) {
        postMessage({
            type: 'create'
        });
    };
    ...
    /**
     ...
     @method send
     @param {Object} payload    example: {id: 1, jsonrpc: '2.0', 'method': 'ele_someMethod', params: []}
     @param {Function} callback the callback to call
     */
    // TODO transform to: send(method, params, callback)
    ElementremProvider.prototype.send = function send(payload, callback) {
    ...
    // TODO set real elementrem provider
    // window.elementrem = new ElementremProvider();


    // For backwards compatibility of web3.currentProvider;
    ElementremProvider.prototype.sendSync = function () {
        return {jsonrpc: '2.0', error: {"code": -32603, message: 'Sync calls are not anymore supported in Mist :\\'}};
    };
    ElementremProvider.prototype.sendAsync = ElementremProvider.prototype.send;
    ElementremProvider.prototype.isConnected = function () {
        return true;
    };
    window.web3 = {
        currentProvider: new ElementremProvider()
    };
})();
