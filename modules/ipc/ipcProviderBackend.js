...
class IpcProviderBackend {
                            ...
                            return new Q((resolve, reject) => {
                                let onStateChange = (newState) => {
                                    if (elementremNode.STATES.CONNECTED === newState) {
                                        ...
                                        log.debug(`Elementrem node connected, resume connecting socket ${ownerId}`);
    ...
    /**
     * Handler for when Elementrem node state changes.
     *
     * Auto-reconnect sockets when elementrem node state changes
     *
