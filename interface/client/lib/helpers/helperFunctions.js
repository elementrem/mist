...
@param {Element} elemens   DOM-Elements elemens, selects, inputs and textareas, to get values from. Must have a name tag
...
**/
// Helpers.formValuesToParameters = function(elemens) {
//     var parameters = {};

//     $(elemens).each(function(){
//         var $elemen = $(this),
//             name = $elemen.attr('name'),
//             value = $elemen.val();
...
//             else if($elemen.attr('type') === 'radio')
//                 parameters[name] = ($elemen.is(':checked')) ? true : false;
//             else if($elemen.attr('type') === 'checkbox')
//                 parameters[name] = ($elemen.is(':checked')) ? true : false;
//             else
...
//     number = web3.fromMey(number, LocalStore.get('elementUnit'));

//     return Helpers.formatNumber(number, format) +' '+ LocalStore.get('elementUnit');
// };