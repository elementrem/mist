...
Template['popupWindows_sendTransactionConfirmation'].onCreated(function(){
    ...
    this.autorun(function(){
        ...
        if(data) {
            ...
            if(!data.gasPrice) {
                web3.ele.getGasPrice(function(e, res){
                    if(!e) {
            ...
            if(data.to) {
                web3.ele.getCode(data.to, function(e, res){
            ...
            if(data.from) {
                web3.ele.getCode(data.from, function(e, res){
                    if(!e && res && res.length > 2) {
            ...
            web3.ele.estimateGas(estimateData, function(e, res){
...
Template['popupWindows_sendTransactionConfirmation'].helpers({
    ...
    */
    'totalAmount': function(){
        var amount = EleTools.formatBalance(this.value, '0,0.00[0000000000000000]', 'element');
    ...
    /**
    Calculates the fee used for this transaction in element
    ...
    */
    'estimatedFee': function() {
        ...
        if(gas && this.gasPrice)
            return EleTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000] unit', 'element');
    },
    /**
    Calculates the provided gas amount in element
    ...
    */
    'providedGas': function() {
        ...
        if(gas && this.gasPrice)
            return EleTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000]', 'element');
    },
    /**
...
Template['popupWindows_sendTransactionConfirmation'].events({
    /**
    Gets the new provided gas in element amount and calculates the resulting providedGas
