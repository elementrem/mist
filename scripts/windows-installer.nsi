...
!define GROUPNAME "Elementrem"
!define HELPURL "https://github.com/elementrem/mist/releases/issues"
!define UPDATEURL "https://github.com/elementrem/mist/releases"
!define ABOUTURL "https://elementrem.org"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\Elementrem"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Gele incoming peers (TCP:30707)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Gele\unpacked\gele.exe" "" "" "Elementrem" 30707 "" "" ""
    #SimpleFC::AdvAddRule "Gele outgoing peers (TCP:30707)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Gele\unpacked\gele.exe" "" "" "Elementrem" "" 30707 "" ""
    #SimpleFC::AdvAddRule "Gele UDP discovery (UDP:30707)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Gele\unpacked\gele.exe" "" "" "Elementrem" "" 30707 "" ""
